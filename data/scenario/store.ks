...
[chara_shake name="ceo" count=1 swing=20 time=300]
#社長
おお、よく来てくれたな。[l][r]
...
[if exp="f.sim.state.answer[f.selected]==true"]
	[jump  storage="store.ks"  target="*correct"  ]
[else]
	[jump  storage="store.ks"  target="*incorrect"  ]
[endif]
[s]
...
*correct
	...
	[chara_shake name="ceo" count=1 swing=20 time=300]
	#社長
	ありがとう。君のおかげであの店のレジもスムーズに流れるようになったよ。[l][r]
	これでお客様の不満も解消されるだろう。[l][r]
	また何かあったらよろしく頼むよ。[p]
	[jump  storage="store.ks"  target="*scenario-end"  ]
[s]
...
[freeimage layer=2 page=fore]
;[hide_incorrect_message_window time=100]
[jump  storage="store.ks"  target="*backtitle-jump"  ]
[s]
